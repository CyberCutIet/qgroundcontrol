    ...
    static const QVariantList toolBarIndicatorList = QVariantList(
        {
            ...
            QVariant::fromValue(QUrl::fromUserInput(QStringLiteral("qrc:/qml/QGroundControl/Toolbar/RadxaRSSIIndicator.qml"))),
            QVariant::fromValue(QUrl::fromUserInput(QStringLiteral("qrc:/qml/QGroundControl/Toolbar/RpiRSSIIndicator.qml"))),
            QVariant::fromValue(QUrl::fromUserInput(QStringLiteral("qrc:/qml/QGroundControl/Toolbar/PacketLossIndicator.qml"))),
            QVariant::fromValue(QUrl::fromUserInput(QStringLiteral("qrc:/qml/QGroundControl/Toolbar/DualJoystickIndicator.qml"))),
        }
    );
